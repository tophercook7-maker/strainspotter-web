...
- ⬜ **Chat phase 2**: grow-group chat on the seeded system groups (`chat_threads` 101-105 already exist in prod); consumer DMs only after report/block + no-sales keyword flagging exist (store-policy risk).
