...
create index chat_participants_thread_idx on public.chat_participants(thread_id);
create index chat_participants_user_idx on public.chat_participants(user_id);
create unique index chat_participants_thread_user_uniq on public.chat_participants(thread_id, user_id);
...
create index chat_ai_requests_user_idx on public.chat_ai_requests(user_id, created_at desc);
create index chat_ai_requests_thread_idx on public.chat_ai_requests(thread_id);
...
-- Policies: threads readable by participants
...
-- Messages: insert as self, only if participant; AI/system via service role only
