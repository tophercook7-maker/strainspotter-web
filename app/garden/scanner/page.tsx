  ...
  return (
    <>
      ...
      <div className="w-full pb-24 md:pb-16 space-y-6">
        ...
        <div className="rounded-xl border border-white/15 bg-white/[0.06] backdrop-blur-xl p-5 sm:p-6 sticky bottom-0 md:static z-10 bg-black/95 md:bg-transparent backdrop-blur-sm md:backdrop-blur-none shadow-lg shadow-black/20">
