      ...
      <main className="min-h-screen bg-black text-white">
        <div className="mx-auto w-full max-w-[720px] px-4 py-12">
          <div className="rounded-3xl border border-white/15 bg-white/10 p-8 backdrop-blur-xl shadow-2xl shadow-black/30">
            <h1 className="text-4xl font-extrabold tracking-tight mb-4">Dispensaries</h1>
            <p className="text-white/80 text-lg mb-6">
              Find nearby dispensaries and compare strains, prices, and availability. 
              Discover where to purchase the cultivars you've identified.
            </p>
