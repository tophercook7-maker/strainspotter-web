  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Name */}
        <div style={{ fontWeight: 800, fontSize: 24, color: "#fff", marginBottom: 6, lineHeight: 1.2 }}>
          {s.name}
        </div>
        ...
        <span style={{
          ...
          background: tc.bg, border: `1px solid ${tc.border}44`,
          fontSize: 13, fontWeight: 700, color: tc.text, marginBottom: 16,
        }}>
          {s.type}
        </span>
        ...
        {/* Description */}
        {s.description && (
          <div style={{ fontSize: 14, color: "rgba(255,255,255,0.7)", lineHeight: 1.65, marginBottom: 16 }}>
            {s.description}
          </div>
        )}
