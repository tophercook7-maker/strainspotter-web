...
export interface RankedScanSummary {
  ...
  /** Repeated wrong tops across scans + no label text */
  uncertainVisualEvidence?: boolean;
  uncertaintyMessage?: string;
  /** API may still return ranked rows below usual UI threshold */
  lowConfidencePossibleMatches?: boolean;
...
export interface RankedScanPayload {
  status: "ok" | "poor_image" | "ambiguous" | "uncertain";
