...
// Colocated with this module (NOT under root /data/, which .vercelignore strips
// from the function bundle — request-time data must live under lib/, like
// lib/data/strains.json). Regenerated by scripts/fit-confidence-calibration.mjs.
import table from "./calibrationTable.json";
