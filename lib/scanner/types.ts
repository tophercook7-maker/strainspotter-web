...
// Canonical scan payload stored in `scans.result_payload` (backend v1.0)
export type ScanResultPayloadV1 = {
  version: "1.0";
  scan_id: string | null;
  model?: {
    name?: string;
  ...
  traits?: {
    type?: "indica" | "sativa" | "hybrid" | "unknown" | string;
    effects?: string[];
    flavors?: string[];
    terpenes?: string[];
  };
  grow_characteristics?: {
    difficulty?: "easy" | "moderate" | "hard" | "unknown" | string;
    flower_time_days?: { min: number | null; max: number | null };
    yield?: "low" | "medium" | "high" | "unknown" | string;
  };
  lineage?: {
    parents?: string[];
    notes?: string | null;
...
export function isScanResultPayloadV1(v: any): v is ScanResultPayloadV1 {
  return !!v && typeof v === "object" && v.version === "1.0" && !!v.primary_match;
}
