...
interface GrowCoachPaywallProps {
  isOpen: boolean;
  onClose: () => void;
  onUpgrade?: () => Promise<void>;
}

export default function GrowCoachPaywall({ isOpen, onClose, onUpgrade }: GrowCoachPaywallProps) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
      <div className="bg-[var(--botanical-bg-surface)] border border-[var(--botanical-border)] rounded-xl p-8 max-w-md w-full">
        ...
        <p className="text-lg text-[var(--botanical-text-primary)] mb-6 leading-relaxed">
          AI-powered guidance built on your Grow Logbook.
          <br />
          Diagnose issues, optimize stages, and learn what works.
        </p>
